...
- 共同工坊下拉补齐南瓜、辛火、桂露、茶心和石根五组共同丹炉偏丹膏 / 废丹灰 / 奇丹晶结果分支；前端继续只提交白名单配方，产物入仓、结果类型、consume / deposit 流水和高价值 / 稀有保护由服务端回执读回。
...
- 共同工坊下拉新增温阳偏丹膏、温阳废丹灰和温阳奇丹晶三条结果分支；前端只提交白名单配方，产物入仓、结果类型、consume / deposit 流水和高价值 / 稀有保护继续由服务端回执读回。
- 共同工坊下拉新增谷气偏丹膏、谷气废丹灰和谷气奇丹晶三条结果分支；前端只提交白名单配方，产物入仓、结果类型、consume / deposit 流水和高价值 / 稀有保护继续由服务端回执读回。
- 共同工坊下拉新增芝香偏丹膏、芝香废丹灰和芝香奇丹晶三条结果分支；前端只提交白名单配方，产物入仓、结果类型、consume / deposit 流水和高价值 / 稀有保护继续由服务端回执读回。
