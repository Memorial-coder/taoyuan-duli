...
### 0617 放牧与畜牧产出修正
- 放牧现在只会提前收取已经到产出的牲口产品，不再绕过产出周期；像牦牛这类 `produceDays = 2` 的牲口也不能靠每天放牧变成每天产奶。
- 放牧与每日畜牧场自动产出的动物产品都会结算农耕经验，雨天/雷雨天的日结产出同样计入经验；放牧后也不再清掉特殊饲料效果。
- `qa:animal-production-guards` 补充放牧周期、放牧/日结经验、雨天日结和饲料状态回归守卫。
