...
### 0528 辣椒腌制炼丹差异
- 辣椒用途表新增 `pickle` 标签和泡椒推荐用途，继续保留料理提味、炼丹、药材和节会热血餐定位。
- 既有泡椒链路现在可从辣椒用途标签读回：辣椒经酱缸成为泡椒后进入辛火行气丸主材，也进入赛舟饭团 / 辛火赛舟饭团料理链；百科和搜索沿用加工来源与配方入口，不新增扣料规则或存档字段。

### 0528 茶叶料理炼丹差异
- 茶叶用途表新增 `alchemy` 标签和茶心凝神丹推荐用途，继续保留制茶、待客、赠礼、订单和药材定位。
- 既有茶心凝神丹丹方现在可从茶叶用途标签读回：茶叶先经制茶机成为绿茶，再与莲心粉、蜂蜜炼成文游对话 / 节会拜访凝神主丹；百科和搜索沿用加工来源与丹炉配方入口，不新增叠加 buff 或存档字段。
...
- 清心莲系共同丹炉新增偏丹、废丹和奇丹三条结果白名单，产物进入共同仓库并保留结果类型、协作成功率、来源资产和高价值 / 稀有取出保护。
