...
### 0614 土地与温室肥料保留修复
- 收获普通作物、多茬作物最后一次收获、巨型作物收获，以及虫害 / 杂草 / 缺水 / 雷击 / 乌鸦导致作物被清掉时，只要地块仍回到已耕状态，就会保留原肥料；只有已耕地退回荒地时才清除肥料。
- 温室作物收获后同样保留地块肥料，避免普通土地和温室出现“有些收获后肥料还在、有些直接消失”的不一致。
- 新增 `qa:fertilizer-retention`，直接验证普通地块、巨型作物与温室收获后的肥料保留行为。
