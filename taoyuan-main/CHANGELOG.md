...
### 0617 工坊铸魔与工具附魔
- 工坊 Lv.7 新增“武器铸魔”，可消耗青铜锭、秘银锭和暗影矿为武器随机获得基础附魔；Lv.10 开放定向附魔，消耗秘银锭、暗影矿、五彩碎片和龙玉指定目标词条。
- 工坊 Lv.15 新增“保留重铸”，消耗秘银锭、虚空矿、五彩碎片和龙玉，将已有武器附魔重铸为不同词条，避免洗回原附魔。
- 参考星露谷附魔方向扩展武器池：新增“迅捷”（矿洞战斗行动时间 -15%）、“破甲”（攻击无视目标 30% 防御）和“镇魂”（对幽魂、暗影、虚空与亡骨类敌人伤害 +25%），定向附魔与保留重铸可选完整武器池。
- 工具附魔同步扩展镐子词条：保留“石屑”（空区域 20% 概率石材×1），新增“省力”（矿洞探索体力 -15%）、“疾手”（矿洞探索与战斗耗时 -15%）和“丰采”（矿石格 15% 概率矿石数量 +1）；新增 `qa:workshop-enchant-guards` 守护工坊铸魔等级、材料、存档字段和采矿触发。
- 继续参考星露谷的功能型附魔补充词条：武器新增“虫猎”（对虫 / 蛛 / 蟹类伤害 +35%）、“斩邪”（对不死与虚影类暴击率 +15%）、“残响”（追击概率 +18%，追击至少 40% 伤害）和“割草”（清除农田杂草 35% 概率获得干草×1）；镐子新增“炼矿”（矿石格 10% 概率额外下一阶矿石×1）和“寻宝”（矿石格 8% 概率额外宝石或古物×1）。
- 工坊 Lv.10 追加“装备附魔”，戒指可选“聚灵 / 招财 / 探宝”，帽子可选“护心 / 清明 / 草识”，鞋子可选“轻身”（移动速度 +12%）、“稳步”和“踏矿”；装备附魔会随戒指 / 帽子 / 鞋子实例存档，并让装备预设按同名装备的附魔版本精确匹配。
