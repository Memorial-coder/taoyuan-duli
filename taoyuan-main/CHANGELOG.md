...
- 山洞开放态复位只写入个人主状态变更回执和审计，不返还山洞解锁材料，不触碰个人铜币、背包、农田、共同基金或共同仓库；`home.farmhouseLevel` 仍保持未开放。
...
- 温室解锁态复位只写入个人主状态变更回执和审计，不返还温室材料，不触碰个人铜币、背包、农田、共同基金或共同仓库；`home.farmhouseLevel / home.caveUnlocked` 仍保持未开放。
