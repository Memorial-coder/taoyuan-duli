...
export const CROPS: CropDef[] = [
  ...
  },
  {
    ...
    seedPrice: 25,
    deepWatering: true,
    description: '水乡风味，嫩白清脆，需深度灌溉。'
  },
  {
    id: 'bitter_gourd',
    name: '苦瓜',
    seedId: 'seed_bitter_gourd',
    season: ['summer'],
    growthDays: 5,
    sellPrice: 65,
    seedPrice: 18,
    deepWatering: false,
    description: '清热解暑，苦中回甘的夏日蔬菜。',
    regrowth: true,
    regrowthDays: 3,
    maxHarvests: 4
  },
  // 秋季
  {
    id: 'chestnut',
    name: '板栗',
    seedId: 'seed_chestnut',
    season: ['autumn'],
    growthDays: 9,
    sellPrice: 160,
    seedPrice: 45,
    deepWatering: false,
    description: '金秋板栗香，糯甜软糯，是秋季的滋补佳品。'
  },
  // 冬季
  {
    id: 'shepherd_purse',
    name: '荠菜',
    seedId: 'seed_shepherd_purse',
    season: ['winter'],
    growthDays: 4,
    sellPrice: 50,
    seedPrice: 12,
    deepWatering: false,
    description: '田间野趣，清香鲜嫩，冬末春初的野菜珍品。',
    regrowth: true,
    regrowthDays: 3,
    maxHarvests: 4
  },
  {
    id: 'snow_mustard',
    name: '雪里蕻',
    seedId: 'seed_snow_mustard',
    season: ['winter'],
    growthDays: 5,
    sellPrice: 60,
    seedPrice: 15,
    deepWatering: false,
    description: '耐寒的腌菜原料，雪中愈显翠绿。',
    regrowth: true,
    regrowthDays: 3,
    maxHarvests: 3
  },
  {
    id: 'winter_bamboo',
    name: '冬笋',
    seedId: 'seed_winter_bamboo',
    season: ['winter'],
    growthDays: 7,
    sellPrice: 120,
    seedPrice: 35,
    deepWatering: false,
    description: '深藏土中的冬笋，鲜嫩细腻，挖掘之乐。'
  },
  // 经济作物
  {
    id: 'cotton',
    ...
    seedPrice: 28,
    deepWatering: false,
    description: '雪白蓬松的棉花，纺织布匹的重要原材料。'
  },
  {
    id: 'mulberry',
    name: '桑叶',
    seedId: 'seed_mulberry',
    season: ['spring', 'summer'],
    growthDays: 4,
    sellPrice: 40,
    seedPrice: 10,
    deepWatering: false,
    description: '养蚕的必备食料，翠绿鲜嫩，可反复采摘。',
    regrowth: true,
    regrowthDays: 2,
    maxHarvests: 6
  }
