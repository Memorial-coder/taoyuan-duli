...
export const ONLINE_VISUAL_FESTIVAL_ACTIVITY_CALENDAR: OnlineVisualActivityScheduleEntry[] = [
  {
    ...
    rewardSettlement: '只定义奖励池口径，实际落账继续走系统活动房间记录。',
  ...
  },
  {
    ...
    rewardSettlement: '名次和称号只从系统赛舟记录读回，不由前端发奖。',
  ...
  },
  {
    ...
    rewardSettlement: '关系线索只做纪念与回看，跨玩家奖励仍按系统记录收口。',
  ...
  },
  {
    ...
    rewardSettlement: '集市与家宴奖励仅定义投放层，真实资产写回必须由系统记录执行。',
  ...
  },
  {
    ...
    rewardSettlement: '称号、纪念和节会人气从系统结算读回，当前界面只展示排期。',
...
export const ONLINE_VISUAL_DAILY_ACTIVITY_ROTATION: OnlineVisualActivityScheduleEntry[] = [
  {
    ...
    rewardSettlement: '每日次数、复核和收益上限继续由庄园系统结算。',
    npcLine: '来访小童：帮忙浇一畦就好，别把主人家的节奏打乱。',
    replayRetention: '过期后保留访客记录、照料对象、健康度变化和频次限制摘要。',
  ...
  },
  {
    ...
    rewardSettlement: '公共订单收益只按系统确认交付和分账记录落账。',
    npcLine: '订单板伙计：今天这单分三段，谁有空就接下一段。',
    replayRetention: '过期后保留订单故事流转、阶段贡献者和分账记录。',
  ...
  },
  {
    ...
    rewardSettlement: '矿洞收益继续由活动房间系统结算记录落账。',
...
export const ONLINE_VISUAL_WEEKLY_ACTIVITY_ROTATION: OnlineVisualActivityScheduleEntry[] = [
  {
    ...
    rewardSettlement: '公共工程收益从村社系统阶段和史册记录读回。',
  ...
  },
  {
    ...
    rewardSettlement: '完工联动只提供系统房间入口描述，不直接发个人资产。',
  ...
  },
  {
    ...
    rewardPoolLabel: '阶段贡献、家族声望、订单故事和分账记录。',
    rewardSettlement: '订单收益仍按系统确认交付、共同基金选择和分账记录落账。',
    npcLine: '账房先生：这单要分头办，账目最后一起清。',
    replayRetention: '过期后保留订单故事、阶段贡献、分账与补偿记录。',
  ...
  },
  {
    ...
    rewardSettlement: '本轮只定义入口，真实共同资产奖励必须另走系统确认链路。',
...
export const ONLINE_VISUAL_SEASONAL_ACTIVITY_ROTATION: OnlineVisualActivityScheduleEntry[] = [
  {
    ...
    rewardSettlement: '评级奖励必须走系统赛季记录，本轮只落展示定义。',
  ...
  },
  {
    ...
    visualScene: '按节会现场素材、房间记录和好友回看汇总留影。',
    rewardPoolLabel: '纪念册、称号、卡框和好友回看，不新增资源产出。',
    rewardSettlement: '只读回看来自既有节会房间记录和纪念册记录。',
...
export const ONLINE_VISUAL_EXPIRED_ACTIVITY_RETENTION = [
  '活动过期后优先保留纪念册、史册、订单故事或访客记录，不删除系统记录。',
  '节会与活动房间提供复刻入口时，只复刻入口和回看，不自动重发奖励。',
  '配置缺失或功能关闭时，排期仍指向备用操作面板、只读纪念或对应模块总览。',
] as const
