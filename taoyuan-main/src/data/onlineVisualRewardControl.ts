...
export const ONLINE_VISUAL_REWARD_CONTROL_POLICIES: OnlineVisualRewardControlPolicy[] = [
  {
    ...
    performanceReward: '表现奖励只读系统房间分数、节点贡献、名次或完成度。',
    collaborationReward: '协作奖励优先给称号、人气、纪念和轻效率，不给稀有材料稳定产出。',
    memorialReward: '纪念奖励落在路线回放、留影、称号和纪念册，不重复发资产。',
    serverAuthority: '活动房间奖励必须由系统结算记录和重复提交保护落账。',
    capSummary: '单局奖励受房间结算次数、成员贡献和重复领取保护约束。',
  ...
  },
  {
    ...
    memorialReward: '主人访客记录保留谁帮了什么、何时帮和系统记录。',
    serverAuthority: '照料次数、健康度、访客记录和复核记录由庄园系统写入。',
    capSummary: '单访客每日次数、单庄园每日被照料次数和频次限制同时生效。',
  ...
  },
  {
    ...
    memorialReward: '访客记录保留对象、数量、主人保留比例、留言和争议记录。',
    serverAuthority: '偷菜收益、补偿、日志、主人开关和频次限制必须由系统结算。',
  ...
  },
  {
    ...
    performanceReward: '交付质量、时效和阶段完成度只影响系统分账摘要。',
    collaborationReward: '多人分账按阶段贡献者和确认交付记录拆分。',
    memorialReward: '订单故事流转、阶段贡献、补偿和分账记录可长期回看。',
    serverAuthority: '公共订单收益必须由系统确认交付、分账记录或共同基金入账。',
    capSummary: '每单只结算一次，重复确认、补偿重放和共同基金选择都受重复提交保护。',
  ...
  },
  {
    ...
    serverAuthority: '公共工程阶段、仓廪周结算和公共效果由村社系统快照读回。',
    capSummary: '贡献包、周结算、灾害应对和节会成本下降按系统周期限制。',
  ...
  },
  {
    ...
    performanceReward: '点亮主灯、解谜、维持秩序和龙舟名次只读房间记录。',
    collaborationReward: '协作表现优先转成留影、署名、称号和好友回看。',
    memorialReward: '留影册、节会纪念册、路线回看和复刻入口长期保留。',
    serverAuthority: '节会纪念和称号从活动房间结算记录与纪念册记录读回。',
  ...
  },
  {
    ...
    serverAuthority: '真实共同资产奖励必须另走共同庄园系统确认链路，且读回个人资产不变边界。',
  ...
  },
  {
    ...
    collaborationReward: '公共订单、节会供品和共同工坊只按系统扣料记录或共同仓库流水结算。',
    memorialReward: '消耗去向、用途标签、来源库存和公共仓记录可在订单、百科、共同流水或回看中读回。',
    serverAuthority: '个人侧由背包 / 仓库消耗链路扣料，联机与共同庄园侧由系统消耗记录或结算记录扣料。',
  ...
  },
  {
    ...
    serverAuthority: '共同料理 / 炼丹由共同庄园系统写入消耗 / 入库记录，个人侧按本地库存与每日限制结算。',
  ...
  },
  {
    ...
    serverAuthority: '家族订单、声望奖励、节会奖励和建筑奖励必须由系统记录、共同基金或共同仓库结算。',
    capSummary: '声望有每周上限和领取成本；节会与订单奖励按重复提交保护、周期和共享池路径限制。',
    antiInflationRule: '家族庄园不稳定产出个人硬资源，少量硬资源必须进入共享池并保留补偿 / 回滚记录。',
...
export const ONLINE_VISUAL_REWARD_GLOBAL_GUARDRAILS = [
  '所有跨玩家奖励必须由系统记录、确认交付、公共工程快照或庄园复核落账。',
  ...
  '共同庄园和家族庄园硬资源奖励只走共享池、周期上限和重复提交保护，不覆盖单人经营主线。',
  '配置缺失时默认保守：只读入口和备用操作面板保留，收益不扩大。',
] as const
