...
import { MAX_MINE_FLOOR } from './mine'
...
export const QUARRY_MUSEUM_ARTIFACT_ITEM_IDS = QUARRY_ARTIFACT_POOL.map(entry => entry.itemId)

export const QUARRY_EXPANSION_STAGES: QuarryExpansionStage[] = [
  { fromSize: 8, toSize: 9, moneyCost: 5000, materialCosts: [{ itemId: 'stone', quantity: 200 }, { itemId: 'wood', quantity: 100 }], requiredClearedCount: 30, requiredDeepClearCount: 0, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 100, requiredMiningLevel: 20, description: '清理东侧塌方，开辟新的开采区。' },
  { fromSize: 9, toSize: 10, moneyCost: 8000, materialCosts: [{ itemId: 'stone', quantity: 300 }, { itemId: 'copper_ore', quantity: 50 }], requiredClearedCount: 60, requiredDeepClearCount: 5, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 100, requiredMiningLevel: 20, description: '打通南侧碎石堆，拓展采矿面。' },
  { fromSize: 10, toSize: 11, moneyCost: 12000, materialCosts: [{ itemId: 'iron_ore', quantity: 80 }, { itemId: 'stone', quantity: 400 }], requiredClearedCount: 100, requiredDeepClearCount: 10, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 110, requiredMiningLevel: 20, description: '加固西侧支撑，扩大作业面积。' },
  { fromSize: 11, toSize: 12, moneyCost: 18000, materialCosts: [{ itemId: 'gold_ore', quantity: 30 }, { itemId: 'iron_ore', quantity: 60 }], requiredClearedCount: 150, requiredDeepClearCount: 20, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 120, requiredMiningLevel: 20, description: '爆破北侧岩壁，连通深层矿脉。' },
  { fromSize: 12, toSize: 13, moneyCost: 25000, materialCosts: [{ itemId: 'crystal_ore', quantity: 40 }, { itemId: 'gold_ore', quantity: 25 }], requiredClearedCount: 220, requiredDeepClearCount: 35, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 130, requiredMiningLevel: 20, description: '疏通积水坑道，露出地下矿层。' },
  { fromSize: 13, toSize: 14, moneyCost: 35000, materialCosts: [{ itemId: 'shadow_ore', quantity: 30 }, { itemId: 'crystal_ore', quantity: 35 }], requiredClearedCount: 300, requiredDeepClearCount: 50, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 140, requiredMiningLevel: 20, description: '凿开暗影矿层入口，扩展到深层。' },
  { fromSize: 14, toSize: 15, moneyCost: 48000, materialCosts: [{ itemId: 'shadow_ore', quantity: 40 }, { itemId: 'void_ore', quantity: 15 }], requiredClearedCount: 400, requiredDeepClearCount: 70, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 150, requiredMiningLevel: 20, description: '打通虚空裂隙通道，开采稀有矿脉。' },
  { fromSize: 15, toSize: 16, moneyCost: 65000, materialCosts: [{ itemId: 'void_ore', quantity: 25 }, { itemId: 'shadow_ore', quantity: 35 }], requiredClearedCount: 520, requiredDeepClearCount: 90, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 160, requiredMiningLevel: 20, description: '稳定虚空矿区结构，扩大安全开采范围。' },
  { fromSize: 16, toSize: 17, moneyCost: 85000, materialCosts: [{ itemId: 'void_ore', quantity: 30 }, { itemId: 'iridium_ore', quantity: 10 }], requiredClearedCount: 660, requiredDeepClearCount: 115, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 170, requiredMiningLevel: 20, description: '开拓铱矿深层区域。' },
  { fromSize: 17, toSize: 18, moneyCost: 110000, materialCosts: [{ itemId: 'iridium_ore', quantity: 20 }, { itemId: 'void_ore', quantity: 25 }], requiredClearedCount: 820, requiredDeepClearCount: 145, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 180, requiredMiningLevel: 20, description: '爆破深层岩层，连通铱矿富集带。' },
  { fromSize: 18, toSize: 19, moneyCost: 140000, materialCosts: [{ itemId: 'iridium_ore', quantity: 30 }, { itemId: 'obsidian', quantity: 15 }], requiredClearedCount: 1000, requiredDeepClearCount: 180, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 190, requiredMiningLevel: 20, description: '清理黑曜岩层塌方，露出古老矿脉。' },
  { fromSize: 19, toSize: 20, moneyCost: 180000, materialCosts: [{ itemId: 'obsidian', quantity: 25 }, { itemId: 'iridium_ore', quantity: 35 }], requiredClearedCount: 1200, requiredDeepClearCount: 220, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 200, requiredMiningLevel: 20, description: '打通龙玉矿脉通道，开辟珍贵矿区。' },
  { fromSize: 20, toSize: 21, moneyCost: 230000, materialCosts: [{ itemId: 'dragon_jade', quantity: 10 }, { itemId: 'obsidian', quantity: 20 }], requiredClearedCount: 1450, requiredDeepClearCount: 270, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 210, requiredMiningLevel: 20, description: '稳固龙玉矿区结构。' },
  { fromSize: 21, toSize: 22, moneyCost: 290000, materialCosts: [{ itemId: 'dragon_jade', quantity: 15 }, { itemId: 'iridium_ore', quantity: 40 }], requiredClearedCount: 1720, requiredDeepClearCount: 320, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 220, requiredMiningLevel: 20, description: '扩展龙玉开采面积。' },
  { fromSize: 22, toSize: 23, moneyCost: 360000, materialCosts: [{ itemId: 'dragon_jade', quantity: 20 }, { itemId: 'obsidian', quantity: 30 }], requiredClearedCount: 2020, requiredDeepClearCount: 380, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 230, requiredMiningLevel: 20, description: '打通深层龙玉矿脉连接。' },
  { fromSize: 23, toSize: 24, moneyCost: 440000, materialCosts: [{ itemId: 'dragon_jade', quantity: 25 }, { itemId: 'iridium_ore', quantity: 50 }], requiredClearedCount: 2350, requiredDeepClearCount: 450, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 240, requiredMiningLevel: 20, description: '稳定深层矿脉结构。' },
  { fromSize: 24, toSize: 25, moneyCost: 530000, materialCosts: [{ itemId: 'dragon_jade', quantity: 30 }, { itemId: 'obsidian', quantity: 35 }], requiredClearedCount: 2700, requiredDeepClearCount: 530, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 250, requiredMiningLevel: 20, description: '开拓深层岩层最后的安全区域。' },
  { fromSize: 25, toSize: 26, moneyCost: 630000, materialCosts: [{ itemId: 'dragon_jade', quantity: 35 }, { itemId: 'iridium_ore', quantity: 60 }], requiredClearedCount: 3080, requiredDeepClearCount: 620, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 260, requiredMiningLevel: 20, description: '凿开最深处的岩层屏障。' },
  { fromSize: 26, toSize: 27, moneyCost: 740000, materialCosts: [{ itemId: 'dragon_jade', quantity: 40 }, { itemId: 'obsidian', quantity: 40 }], requiredClearedCount: 3480, requiredDeepClearCount: 720, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 270, requiredMiningLevel: 20, description: '打通地下暗河通道。' },
  { fromSize: 27, toSize: 28, moneyCost: 860000, materialCosts: [{ itemId: 'dragon_jade', quantity: 45 }, { itemId: 'iridium_ore', quantity: 70 }], requiredClearedCount: 3900, requiredDeepClearCount: 830, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 280, requiredMiningLevel: 20, description: '加固暗河区域支撑结构。' },
  { fromSize: 28, toSize: 29, moneyCost: 990000, materialCosts: [{ itemId: 'dragon_jade', quantity: 50 }, { itemId: 'obsidian', quantity: 45 }], requiredClearedCount: 4350, requiredDeepClearCount: 950, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 290, requiredMiningLevel: 20, description: '开拓暗河对岸的矿脉。' },
  { fromSize: 29, toSize: 30, moneyCost: 1130000, materialCosts: [{ itemId: 'dragon_jade', quantity: 55 }, { itemId: 'iridium_ore', quantity: 80 }], requiredClearedCount: 4820, requiredDeepClearCount: 1080, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 300, requiredMiningLevel: 20, description: '凿通龙脉核心区域外围。' },
  { fromSize: 30, toSize: 31, moneyCost: 1280000, materialCosts: [{ itemId: 'dragon_jade', quantity: 60 }, { itemId: 'obsidian', quantity: 50 }], requiredClearedCount: 5320, requiredDeepClearCount: 1220, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 310, requiredMiningLevel: 20, description: '打通龙脉核心入口。' },
  { fromSize: 31, toSize: 32, moneyCost: 1450000, materialCosts: [{ itemId: 'dragon_jade', quantity: 70 }, { itemId: 'iridium_ore', quantity: 100 }, { itemId: 'obsidian', quantity: 55 }], requiredClearedCount: 5850, requiredDeepClearCount: 1380, requiredMineFloor: MAX_MINE_FLOOR, requiredSkullFloor: 320, requiredMiningLevel: 20, description: '完成龙脉核心区域的最终开拓，采石场达到最大规模。' }
]
