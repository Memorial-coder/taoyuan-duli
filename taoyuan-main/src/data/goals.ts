...
export const THEME_WEEK_DEFS: ThemeWeekDef[] = [
  {
    ...
    regionFocusRouteIds: ['ancient_road_supply_relay', 'ancient_road_archive_recovery', 'ancient_road_convoy_risk'],
  ...
  },
  {
    ...
    regionFocusRouteIds: ['cloud_highland_patrol', 'cloud_highland_ley_crack', 'cloud_highland_supply_push'],
  ...
  },
  {
    ...
    regionFocusRouteIds: ['ancient_road_archive_recovery', 'ancient_road_convoy_risk', 'cloud_highland_ley_crack', 'cloud_highland_supply_push'],
  ...
  },
  {
    ...
    regionFocusRouteIds: ['mirage_marsh_night_watch', 'mirage_marsh_specimen_drive', 'mirage_marsh_ecology_alert'],
