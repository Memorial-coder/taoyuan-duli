...
export const ITEMS: ItemDef[] = [
  ...
  { id: 'relay_beacon_tag', name: '驿烽铜牌', category: 'artifact', description: '古驿荒道护送风险线留下的铜牌，适合继续接护送单和瀚海前置准备。', sellPrice: 260, edible: false },
  { id: 'marsh_glow_pod', name: '潮沼荧囊', category: 'material', description: '从泽地生态异常节点带回的荧光样本，适合接鱼塘展示、研究和馆务委托。', sellPrice: 210, edible: false },
  {
    id: 'mega_bomb_recipe',
    name: '巨型炸弹配方',
    category: 'misc',
