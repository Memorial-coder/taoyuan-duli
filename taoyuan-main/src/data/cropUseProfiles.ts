...
export const CROP_USE_PROFILES: CropUseProfile[] = [
  ...
  },
  {
    ...
    summary: '油菜与菠菜杂交的耐寒油菜，适合热炒料理、护脉炼丹、榨霜油菜油、灵宠霜油喂食、家畜霜油料、护脉药膳、油坊赠礼、冬祭供品、公共仓霜油备料和霜油订单。'
  },
  {
    cropId: 'purple_melon',
    tags: ['food', 'alchemy', 'pet_feed', 'medicine', 'wine', 'gift', 'festival', 'order', 'online_cost'],
  ...
  },
  {
    ...
    summary: '辣椒与花生杂交的辛香油仁，适合酱料料理、聚火炼丹、榨麻辣仁油、腌麻辣仁、灵宠麻仁喂食、家畜麻仁料、聚火药膳、辛香赠礼、秋祭供品、公共仓麻仁备料和麻辣仁订单。'
  },
  {
    cropId: 'honey_gourd',
    tags: ['food', 'alchemy', 'pet_feed', 'animal_feed', 'oil', 'flour', 'medicine', 'gift', 'festival', 'order', 'online_cost'],
  ...
  },
  {
    ...
    summary: '红枣与生姜杂交的辛甜冬果，适合暖饮料理、养气炼丹、酿辛枣果酒、腌辛枣、灵宠辛枣喂食、家畜辛枣料、暖补药膳、冬夜赠礼、腊祭供品、公共仓辛枣备料和辛枣订单。'
  },
  {
  ...
  },
  {
    ...
    summary: '蜜茶果与翡翠茶经风雨淬炼的三代瓜果，适合清甜料理、凝神炼丹、酿风瓜果酒、灵宠风瓜喂食、家畜风瓜料、清润药膳、行旅赠礼、春风供品、公共仓风瓜备料和风瓜订单。'
  },
  {
    cropId: 'cloud_bean',
    ...
    summary: '蜜茶果与凤凰椒交融出的三代辛甜豆蔬，适合辣酱料理、行气炼丹、制云豆粉、腌云豆椒、灵宠云豆喂食、家畜云豆料、行气药膳、云游赠礼、云集供品、公共仓云豆备料和云豆订单。'
  },
  {
    cropId: 'rain_rice',
    tags: ['food', 'alchemy', 'pet_feed', 'animal_feed', 'flour', 'wine', 'medicine', 'gift', 'festival', 'order', 'online_cost'],
    ...
    summary: '蜜茶果与月光稻沐露而成的三代灵谷，适合润饭料理、续行炼丹、制雨稻米粉、酿雨稻清酒、灵宠饭团、家畜精粮、润泽药膳、雨祭赠礼、祈雨供品、公共仓米包和雨稻订单。'
  },
  {
    cropId: 'hoar_tuber',
    tags: ['food', 'alchemy', 'pet_feed', 'animal_feed', 'flour', 'pickle', 'medicine', 'gift', 'festival', 'order', 'online_cost'],
    ...
    summary: '蜜茶果与霜雪蒜凝霜后的三代根茎，适合羹汤料理、固元炼丹、制霜薯粉、腌霜薯片、灵宠霜薯喂食、家畜霜薯料、固元药膳、霜夜赠礼、冬祭供品、公共仓霜薯备料和霜薯订单。'
  },
  {
    ...
    summary: '蜜茶果与翡翠萝卜汇聚雷雨气息的三代菜蔬，适合脆炒料理、行气炼丹、腌雷菜梗、灵宠雷菜喂食、家畜雷菜料、行气药膳、雷雨赠礼、惊蛰供品、公共仓雷菜备料和雷菜订单。'
  },
  {
    ...
    summary: '蜜茶果与玉竹芽淬炼出的三代彩色灵果，适合蜜盏料理、润脉炼丹、酿虹果虹酿、灵宠虹果喂食、家畜虹果料、润脉药膳、彩虹赠礼、虹桥供品、公共仓虹果备料和虹果订单。'
  },
  {
    cropId: 'dew_bloom',
    ...
    summary: '蜜茶果与金油薯交融出的三代露香花实，适合甜羹料理、凝神炼丹、榨露花香油、酿露花露酿、灵宠露花喂食、家畜露花料、凝神药膳、朝露赠礼、花朝供品、公共仓露花备料和露花订单。'
  },
  {
    cropId: 'dawn_tea',
    tags: ['food', 'alchemy', 'pet_feed', 'animal_feed', 'wine', 'medicine', 'gift', 'festival', 'order', 'online_cost'],
    ...
    summary: '蜜茶果与桃花茶沐露后的三代清香茶作，适合清茗料理、凝神炼丹、酿晨茶花酿、灵宠晨茶喂食、家畜晨茶料、清心药茶、晨露赠礼、春晨供品、公共仓晨茶备料和晨茶订单。'
  },
  {
    cropId: 'dusk_shoot',
    tags: ['food', 'alchemy', 'pet_feed', 'animal_feed', 'flour', 'pickle', 'medicine', 'gift', 'festival', 'order', 'online_cost'],
    ...
    summary: '蜜茶果与红宝豆在星光下蜕变的三代鲜甜笋豆，适合豆羹料理、护脉炼丹、制暮笋粉、腌暮笋豆、灵宠暮笋喂食、家畜暮笋料、护脉药膳、暮色赠礼、星夜供品、公共仓暮笋备料和暮笋订单。'
  },
  {
    cropId: 'star_lotus',
    tags: ['food', 'alchemy', 'pet_feed', 'animal_feed', 'flour', 'wine', 'medicine', 'gift', 'festival', 'order', 'online_cost'],
    ...
    summary: '蜜茶果与双子豆汇聚星辉的三代莲形灵植，适合甜汤料理、安神炼丹、制星莲粉、酿星莲清酿、灵宠星莲喂食、家畜星莲料、安神药膳、星灯赠礼、七夕供品、公共仓星莲备料和星莲订单。'
  },
  {
    ...
    summary: '蜜茶果与碧玉瓜淬炼出的三代华麦，适合麦饼料理、续行炼丹、制风华麦粉、酿风华清酒、灵宠麦团、家畜精粮、续行药膳、风华赠礼、麦风祭供品、公共仓麦包和风华麦订单。'
  },
  {
    ...
    summary: '蜜茶果与珍珠谷交融出的三代云纹芝麻，适合芝麻糊料理、润脉炼丹、榨云华芝油、制云华芝粉、灵宠芝点、家畜芝料、润脉药膳、云纹赠礼、云灯供品、公共仓芝包和云华芝订单。'
  },
  {
    ...
    summary: '蜜茶果与金穗玉米沐露后的三代辛鲜椒作，适合辣羹料理、行气炼丹、腌雨华椒、灵宠暖身喂食、家畜椒料、行气药膳、雨市赠礼、雨神供品、公共仓椒包和雨华椒订单。'
  },
  {
    ...
    summary: '蜜茶果与莲心茶星夜蜕变出的三代寒参，适合参汤料理、固元炼丹、制霜华参粉、酿霜参寒酿、灵宠霜参喂食、家畜霜参料、固元药膳、寒参赠礼、寒山供品、公共仓霜参备料和霜华参订单。'
  },
  {
    ...
    summary: '蜜茶果与紫竹茄汇聚雷气后的三代鲜芽，适合清炒料理、行气炼丹、腌雷华芽、灵宠雷芽喂食、家畜雷芽料、行气药膳、惊雷赠礼、惊蛰供品、公共仓雷华芽备料和雷华芽订单。'
  },
  {
    ...
    summary: '蜜茶果与蜜桃瓜淬炼出的三代彩藤灵果，适合果盏料理、润脉炼丹、酿虹华藤酒、灵宠虹藤喂食、家畜虹藤料、润脉药膳、彩藤赠礼、虹桥供品、公共仓虹藤备料和虹华藤订单。'
  },
  {
    ...
    summary: '蜜茶果与火豆在清风中交融出的三代辛香花蕾，适合炒豆料理、行气炼丹、腌露华蕾、灵宠露蕾喂食、家畜露蕾料、行气药膳、朝露赠礼、花朝供品、公共仓露蕾备料和露华蕾订单。'
  },
  {
    ...
    summary: '蜜茶果与丝豆沐露后的三代清香兰作，适合清羹料理、清心炼丹、酿晨华兰露、灵宠晨兰喂食、家畜晨兰料、清心药膳、雅士赠礼、兰会供品、公共仓晨兰备料和晨华兰订单。'
  },
  {
    ...
    summary: '蜜茶果与双油籽星夜蜕变出的三代葫芦，适合蒸盅料理、固元炼丹、榨暮华葫油、制暮华葫粉、灵宠暮葫喂食、家畜暮葫料、固元药膳、秋夕赠礼、暮葫供品、公共仓暮葫备料和暮华葫订单。'
  },
  {
    ...
    summary: '蜜茶果与莲薯汇聚星辉的三代草本，适合药粥料理、安神炼丹、制星华草粉、酿星草清酿、灵宠星草喂食、家畜星草料、安神药膳、香草赠礼、星灯供品、公共仓星草备料和星华草订单。'
  },
  {
    ...
    summary: '蜜茶果与翡翠南瓜淬炼出的三代翠栗，适合栗糕料理、固元炼丹、制风翠栗粉、酿风栗甜酒、灵宠风栗喂食、家畜风栗料、固元药膳、秋风赠礼、栗供节品、公共仓风栗备料和风翠栗订单。'
  },
  {
    ...
    summary: '蜜茶果与水晶山药清风交融出的三代香杏，适合甜羹料理、润脉炼丹、酿云翠杏酒、灵宠云杏喂食、家畜云杏料、润脉药膳、杏香赠礼、杏花供品、公共仓云杏备料和云翠杏订单。'
  },
  {
    ...
    summary: '蜜茶果与桂花茶沐露后的三代清润梨果，适合梨汤料理、清心炼丹、酿雨翠梨酒、灵宠雨梨喂食、家畜雨梨料、清心药膳、清润赠礼、雨祭供品、公共仓雨梨备料和雨翠梨订单。'
  },
  {
    ...
    summary: '蜜茶果与山竹薯星夜蜕变出的三代寒莓，适合莓酥料理、安神炼丹、制霜翠莓粉、酿霜莓寒酿、灵宠霜莓喂食、家畜霜莓料、安神药膳、寒莓赠礼、冬灯供品、公共仓霜莓备料和霜翠莓订单。'
  },
  {
    ...
    summary: '蜜茶果与金秋果汇聚雷气后的三代暖桃，适合甜盏料理、行气炼丹、酿雷翠桃酒、灵宠雷桃喂食、家畜雷桃料、行气药膳、贺礼赠送、惊雷供品、公共仓雷桃备料和雷翠桃订单。'
  },
  {
    ...
    summary: '蜜茶果与花生薯经风雨淬炼出的三代彩瓜，适合蜜盏料理、润脉炼丹、酿虹翠瓜酒、灵宠虹瓜喂食、家畜虹瓜料、润脉药膳、彩桥赠礼、虹桥供品、公共仓虹瓜备料和虹翠瓜订单。'
  },
  {
    ...
    summary: '蜜茶果与秋枣豆在清风中交融出的三代豆蔬，适合豆羹料理、养气炼丹、制露翠豆粉、腌露翠豆、灵宠露豆喂食、家畜露豆料、养气药膳、朝露赠礼、豆供节品、公共仓露豆备料和露翠豆订单。'
  },
  {
    ...
    summary: '蜜茶果与枣花桃沐露后的三代晨光灵稻，适合米饭料理、续行炼丹、制晨翠米粉、酿晨翠清酒、灵宠饭团、家畜精粮、续行药膳、晨祭赠礼、晨光供品、公共仓稻米备料和晨翠稻订单。'
  },
  {
    ...
    summary: '蜜茶果与姜花菜星夜蜕变出的三代暖薯，适合羹汤料理、驱寒炼丹、制暮翠薯粉、腌暮翠薯片、灵宠暮薯喂食、家畜暮薯料、驱寒药膳、暮色赠礼、暮火供品、公共仓暮薯备料和暮翠薯订单。'
  },
  {
    ...
    summary: '蜜茶果与仙菊菜汇聚星辉后的三代菜蔬，适合清羹料理、清目炼丹、腌星翠菜、灵宠星菜喂食、家畜星菜料、清目药膳、星灯赠礼、星灯供品、公共仓星菜备料和星翠菜订单。'
  },  {
