...
const BASIC_OFFERS: ShopCatalogOfferInput[] = [
  {
    ...
    pool: 'basic',
    name: '竹影屏风',
    description: '永久解锁竹影屏风陈设。全档限购 1 次。',
    price: 880,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'basic',
    name: '清茶小案',
    description: '永久解锁清茶小案陈设。全档限购 1 次。',
    price: 760,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'basic',
    name: '素陶花瓶',
    description: '永久解锁素陶花瓶陈设。全档限购 1 次。',
    price: 520,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'basic',
    name: '庭院石灯',
    description: '永久解锁庭院石灯摆件。全档限购 1 次。',
    price: 1280,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'basic',
    name: '迎宾酒架',
    description: '永久解锁迎宾酒架陈设。全档限购 1 次。',
    price: 1580,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'basic',
    name: '匠作材料包',
    description: '常驻材料补给，含木材与木炭。可重复购买。',
    price: 2400,
    tags: ['功能商品', '材料包', '补给包'],
  ...
  },
  {
    ...
    pool: 'basic',
    name: '渔具补给包',
    description: '常驻渔具补给，含蟹笼与野生鱼饵。可重复购买。',
    price: 3200,
    tags: ['功能商品', '渔具', '补给包'],
  ...
  },
  {
    ...
    pool: 'basic',
    name: '牧场照料包',
    description: '常驻牧场照料物资，含药品、精饲料与干草。可重复购买。',
    price: 2600,
    tags: ['功能商品', '牧场', '补给包'],
  ...
  },
  {
    ...
    pool: 'basic',
    name: '田作灌溉包',
    description: '常驻灌溉起步包，含竹制喷灌器与基础肥料。可重复购买。',
    price: 4800,
  ...
  },
  {
    ...
    pool: 'basic',
    name: '林场采脂包',
    description: '常驻树脂采集工具包，含树液采集器与木材。可重复购买。',
    price: 3600,
  ...
  },
  {
    ...
    pool: 'basic',
    name: '小库房整备册',
    description: '永久仓库箱位 +1。全档限购 1 次。',
    price: 5600,
    purchaseLimits: [{ window: 'lifetime', max: 1 }],
    tags: ['功能商品', '仓储', '服务契约'],
...
const WEEKLY_OFFERS: ShopCatalogOfferInput[] = [
  {
    ...
    pool: 'weekly',
    name: '书香高架',
    description: '永久解锁书香高架陈设。全档限购 1 次。',
    price: 1680,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '彩绸灯笼',
    description: '永久解锁彩绸灯笼陈设。全档限购 1 次。',
    price: 1180,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '旅行大木箱',
    description: '获得一个金箱，并永久开放仓库箱位 +1。每周限购 1 次，全档限购 1 次。',
    price: 6800,
    purchaseLimits: [{ window: 'weekly', max: 1 }, { window: 'lifetime', max: 1 }],
    ...
    uiBadge: '周更惊喜',
    serviceBillingCycle: 'one_off',
    travelSupplyConfig: { routeTag: 'universal', recommendedSystems: ['shop', 'inventory', 'warehouse'], tripDays: 7, consumableCharges: 1 },
    warehouseServiceConfig: { serviceType: 'vault_charter', capacityDelta: 1, billingCycle: 'one_off', maxServiceLevel: 1 },
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '祈雨仪式包',
    description: '内含两枚雨图腾，适合集中经营。每周限购 1 次。',
    price: 5400,
    purchaseLimits: [{ window: 'weekly', max: 1 }],
    tags: ['每周精选', '功能商品', '补给包'],
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '仓契扩建文书',
    description: '永久仓库箱位 +1。每周限购 1 次，全档限购 2 次。',
    price: 8800,
    purchaseLimits: [{ window: 'weekly', max: 1 }, { window: 'lifetime', max: 2 }],
    ...
    uiBadge: '扩建',
    serviceBillingCycle: 'one_off',
    warehouseServiceConfig: { serviceType: 'chest_slot', capacityDelta: 1, billingCycle: 'one_off', maxServiceLevel: 2 },
    effect: { type: 'expand_warehouse', amount: 1 }
  },
  {
    ...
    pool: 'weekly',
    name: '百草收纳盒',
    description: '日常药材补给，含药草与人参。每周限购 1 次。',
    price: 1800,
    purchaseLimits: [{ window: 'weekly', max: 1 }],
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '匠心灌溉箱',
    description: '含铜制喷灌器与高级速生肥，适合冲刺耕作收益。每周限购 1 次。',
    price: 9600,
    purchaseLimits: [{ window: 'weekly', max: 1 }],
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '鱼塘养护包',
    description: '鱼塘与蟹笼经营补给，含鱼食与净水材料。每周限购 1 次。',
    price: 3200,
    purchaseLimits: [{ window: 'weekly', max: 1 }],
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '矿工补给箱',
    description: '矿洞推进物资，含石材、铜锭与铁锭。每周限购 1 次。',
    price: 4800,
    purchaseLimits: [{ window: 'weekly', max: 1 }],
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '酒馆礼品篮',
    description: '来自醉桃源酒馆的轻补给礼篮。每周限购 1 次。',
    price: 2200,
    purchaseLimits: [{ window: 'weekly', max: 1 }],
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '竹编行囊',
    description: '永久背包容量 +1。每周限购 1 次，全档限购 24 次。',
    price: 2400,
    purchaseLimits: [{ window: 'weekly', max: 1 }, { window: 'lifetime', max: 24 }],
    onceOnly: false,
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '仓契小文书',
    description: '永久仓库箱位 +1。每周限购 1 次，全档限购 1 次。',
    price: 7200,
    purchaseLimits: [{ window: 'weekly', max: 1 }, { window: 'lifetime', max: 1 }],
    tags: ['每周精选', '功能商品', '仓储', '服务契约'],
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '花市巡游车',
    description: '永久解锁花市巡游车陈设。全档限购 1 次。',
    price: 4200,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'weekly',
    name: '商队行装箱',
    description: '订单周与远行周的高价值备货箱。每周限购 1 次。',
    price: 7600,
    purchaseLimits: [{ window: 'weekly', max: 1 }],
...
const SEASONAL_OFFERS: ShopCatalogOfferInput[] = [
  {
    ...
    pool: 'seasonal',
    name: '花朝拱门',
    description: '永久解锁春季花饰拱门。全档限购 1 次。',
    price: 1880,
    onceOnly: true,
    seasonLimits: ['spring'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '柳纹地席',
    description: '永久解锁春日柳纹地席。全档限购 1 次。',
    price: 920,
    onceOnly: true,
    seasonLimits: ['spring'],
    decorationUnlockId: 'catalog_willow_mat',
    tags: ['春季限定', '外观', '节庆'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '桃花挂轴',
    description: '永久解锁桃花挂轴陈设。全档限购 1 次。',
    price: 960,
    onceOnly: true,
    seasonLimits: ['spring'],
    decorationUnlockId: 'catalog_peach_scroll',
    tags: ['春季限定', '外观', '收藏'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '荷灯摆台',
    description: '永久解锁夏夜荷灯摆台。全档限购 1 次。',
    price: 1180,
    onceOnly: true,
    seasonLimits: ['summer'],
    decorationUnlockId: 'catalog_lotus_lamp',
    tags: ['夏季限定', '装饰', '节庆', '收藏'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '纳凉石凳',
    description: '永久解锁纳凉石凳组合。全档限购 1 次。',
    price: 1440,
    onceOnly: true,
    seasonLimits: ['summer'],
    decorationUnlockId: 'catalog_cool_bench',
    tags: ['夏季限定', '院子摆件', '装饰'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '青竹帘影',
    description: '永久解锁夏日竹帘收藏品。全档限购 1 次。',
    price: 980,
    onceOnly: true,
    seasonLimits: ['summer'],
    decorationUnlockId: 'catalog_bamboo_blind',
    tags: ['夏季限定', '外观', '收藏'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '枫纹屏风',
    description: '永久解锁枫纹屏风陈设。全档限购 1 次。',
    price: 1680,
    onceOnly: true,
    seasonLimits: ['autumn'],
    decorationUnlockId: 'catalog_maple_screen',
    tags: ['秋季限定', '装饰', '收藏'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '丰收旗幡',
    description: '永久解锁丰收旗幡摆件。全档限购 1 次。',
    price: 1260,
    onceOnly: true,
    seasonLimits: ['autumn'],
    decorationUnlockId: 'catalog_harvest_banner',
    tags: ['秋季限定', '装饰', '节庆'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '望月案设',
    description: '永久解锁中秋望月案设。全档限购 1 次。',
    price: 1760,
    onceOnly: true,
    seasonLimits: ['autumn'],
    decorationUnlockId: 'catalog_moon_set',
    tags: ['秋季限定', '外观', '节庆', '收藏'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '暖炭火盆',
    description: '永久解锁冬日暖炭火盆。全档限购 1 次。',
    price: 1580,
    onceOnly: true,
    seasonLimits: ['winter'],
    decorationUnlockId: 'catalog_brazier',
    tags: ['冬季限定', '装饰', '节庆'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '寒梅窗框',
    description: '永久解锁寒梅窗框外观。全档限购 1 次。',
    price: 980,
    onceOnly: true,
    seasonLimits: ['winter'],
    decorationUnlockId: 'catalog_plum_frame',
    tags: ['冬季限定', '外观', '收藏'],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '梅雪香座',
    description: '永久解锁梅雪香座摆件。全档限购 1 次。',
    price: 1120,
    onceOnly: true,
    seasonLimits: ['winter'],
    decorationUnlockId: 'catalog_incense_stand',
    tags: ['冬季限定', '外观', '收藏'],
    festivalGiftConfig: { season: 'winter', festivalTag: 'winter_plum', giftLevel: 'standard', canRepeat: false },
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '春耕种子礼包',
    description: '春季种子补给，含茶苗、水蜜桃、蚕豆种子各 5 份。本季限购 1 次。',
    price: 720,
    seasonLimits: ['spring'],
    purchaseLimits: [{ window: 'seasonal', max: 1 }],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '夏钓补给包',
    description: '夏季钓鱼补给，含高级鱼饵与魔法鱼饵。本季限购 1 次。',
    price: 2800,
    seasonLimits: ['summer'],
    purchaseLimits: [{ window: 'seasonal', max: 1 }],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '秋收丰收包',
    description: '秋季收成补给，含速生肥与保质土壤。本季限购 1 次。',
    price: 3200,
    seasonLimits: ['autumn'],
    purchaseLimits: [{ window: 'seasonal', max: 1 }],
  ...
  },
  {
    ...
    pool: 'seasonal',
    name: '冬藏备用包',
    description: '冬季经营备用包，含木炭与精饲料。本季限购 1 次。',
    price: 2400,
    seasonLimits: ['winter'],
    purchaseLimits: [{ window: 'seasonal', max: 1 }],
...
const PREMIUM_OFFERS: ShopCatalogOfferInput[] = [
  ...
  },
  {
    ...
    pool: 'premium',
    name: '温室特许状',
    description: '永久解锁温室，无需再提交材料。全档限购 1 次。',
    price: 48000,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'premium',
    name: '虚空箱契约',
    description: '获得一个虚空箱，并永久开放仓库箱位 +1。全档限购 1 次。',
    price: 26000,
    onceOnly: true,
    purchaseLimits: [{ window: 'lifetime', max: 1 }],
  ...
  },
  {
    ...
    pool: 'premium',
    name: '府库扩建札记',
    description: '永久仓库箱位 +2，适合大规模经营。全档限购 1 次。',
    price: 22000,
    onceOnly: true,
    purchaseLimits: [{ window: 'lifetime', max: 1 }],
    tags: ['高价长期商品', '仓储', '服务契约'],
    warehouseServiceConfig: { serviceType: 'vault_charter', capacityDelta: 2, billingCycle: 'one_off', maxServiceLevel: 1 },
  ...
  },
  {
    ...
    pool: 'premium',
    name: '金衡灌溉套组',
    description: '金制喷灌器与保质土壤套组。全档限购 1 次。',
    price: 36000,
    purchaseLimits: [{ window: 'lifetime', max: 1 }],
  ...
  },
  {
    ...
    pool: 'premium',
    name: '林业采脂工坊',
    description: '直接建立一套树脂采集线。全档限购 1 次。',
    price: 24000,
    purchaseLimits: [{ window: 'lifetime', max: 1 }],
    tags: ['高价长期商品', '自动化', '材料包'],
    functionalVoucherConfig: { voucherType: 'automation', charges: 1, reusable: false, targetSystems: ['shop', 'inventory', 'goal'] },
  ...
  },
  {
    ...
    pool: 'premium',
    name: '金鲤头像框',
    description: '永久解锁金鲤头像框外观。全档限购 1 次。',
    price: 12800,
    onceOnly: true,
    tags: ['高价长期商品', '头像框', '收藏'],
    decorationUnlockId: 'catalog_golden_frame',
  ...
  },
  {
    ...
    pool: 'premium',
    name: '牧场启动套组',
    description: '一次性配齐牧场中期物资。全档限购 1 次。',
    price: 28000,
    purchaseLimits: [{ window: 'lifetime', max: 1 }],
    tags: ['高价长期商品', '牧场', '补给包'],
  ...
  },
  {
    ...
    pool: 'premium',
    name: '垂钓大师礼盒',
    description: '高端钓鱼装备补给，含魔法鱼饵与豪华鱼饵。本季限购 1 次。',
    price: 32000,
    purchaseLimits: [{ window: 'seasonal', max: 1 }],
  ...
  },
  {
    ...
    pool: 'premium',
    name: '大府库扩建契约',
    description: '永久仓库箱位 +3，适合后期大仓储布局。全档限购 1 次。',
    price: 38000,
    onceOnly: true,
    purchaseLimits: [{ window: 'lifetime', max: 1 }],
    tags: ['高价长期商品', '仓储', '服务契约'],
    warehouseServiceConfig: { serviceType: 'chest_slot', capacityDelta: 3, billingCycle: 'one_off', maxServiceLevel: 1 },
  ...
  },
  {
    ...
    pool: 'premium',
    name: '御制宝囊',
    description: '永久背包容量 +6，极限扩充携带上限。全档限购 1 次。',
    price: 42000,
    onceOnly: true,
    tags: ['高价长期商品', '补给包'],
  ...
  },
  {
    ...
    pool: 'premium',
    name: '金阙月宴礼盒',
    description: '高资金节庆礼盒，兼顾展示感与即时回报。本季限购 1 次。',
    price: 18000,
    purchaseLimits: [{ window: 'seasonal', max: 1 }],
    luxuryCategory: 'festival_gift',
    tags: ['高价长期商品', '节庆', '收藏'],
  ...
  },
  {
    ...
    pool: 'premium',
    name: '绮彩堂台',
    description: '永久解锁终局家园展示舞台。全档限购 1 次。',
    price: 26000,
    onceOnly: true,
  ...
  },
  {
    ...
    pool: 'premium',
    name: '远征储备库',
    description: '矿洞与长线订单的高价远行储备。每周限购 1 次。',
    price: 34000,
    purchaseLimits: [{ window: 'weekly', max: 1 }],
  ...
  },
  {
    ...
    pool: 'premium',
    name: '商路外包总契',
    description: '签约后 7 日生效，生效期内不可重复购买；到期将按周费自动续约。',
    price: 18000,
