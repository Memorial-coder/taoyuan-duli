  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'npc', name: 'npc', redirect: to => ({ name: 'village', query: to.query, hash: to.hash }) },
        ...
        { path: 'online/society', name: 'online-society', component: () => import('@/views/game/online/OnlineSocietyView.vue') },
        ...
        { path: 'society', name: 'society', redirect: to => ({ name: 'online-society', query: to.query, hash: to.hash }) },
        ...
        { path: 'workshop', name: 'workshop', component: () => import('@/views/game/AsyncProcessingView.vue') },
        { path: 'processing', name: 'processing', redirect: to => ({ name: 'workshop', query: to.query, hash: to.hash }) },
