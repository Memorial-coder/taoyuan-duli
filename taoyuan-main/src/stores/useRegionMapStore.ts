...
export const useRegionMapStore = defineStore('regionMap', () => {
  ...
  const clearBossAndGrantRewards = (regionId: RegionId, dayTag = '') => {
    ...
    if (!recordBossClear(regionId, dayTag)) return null
