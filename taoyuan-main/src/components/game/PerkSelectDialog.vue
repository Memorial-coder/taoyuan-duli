...
<script setup lang="ts">
  ...
  const PERK10_BRANCHES: Record<SkillType, Record<string, PerkOption[]>> = {
    ...
    foraging: {
      ...
      herbalist: [
        { id: 'botanist', name: '植物学家', description: '采集物品质至少为优质' },
  ...
  const PERK15_BRANCHES: Record<SkillType, Perk15Branches> = {
    ...
    foraging: {
      botanist: [
        { id: 'ancient_botanist', name: '上古植物学家', description: '采集物75%概率为极品，否则优质' },
        { id: 'grand_alchemist', name: '大炼金师', description: '食物恢复效果再+50%' }
      ],
      alchemist: [
        { id: 'ancient_botanist', name: '上古植物学家', description: '采集物50%概率为极品，否则优质' },
        { id: 'grand_alchemist', name: '大炼金师', description: '食物恢复效果再+50%' }
      ],
      forester: [
