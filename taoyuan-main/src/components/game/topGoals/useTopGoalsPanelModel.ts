...
import type { useGoalStore } from '@/stores/useGoalStore'
import type { useShopStore } from '@/stores/useShopStore'
import type { useTutorialStore } from '@/stores/useTutorialStore'
