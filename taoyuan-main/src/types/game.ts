...
export type LateGameFeatureFlag =
  | 'lateGameBudget'
  | 'lateGameMaintenance'
  | 'lateGameWeeklyGoals'
  | 'lateGameHanhaiContracts'
  | 'lateGameFishPondWeeklyContest'
  | 'lateGameMuseumExhibit'
...
export interface SystemFlagConfig {
  ...
  introducedSaveVersion?: number
}

export type LateGameFeatureOverrideMap = Partial<Record<LateGameFeatureFlag, boolean>>
