...
<script setup lang="ts">
  ...
  const sharedWorkshopRecipeOptions: SharedWorkshopRecipeOption[] = [
    ...
    { id: 'shared_aged_radish_stew', label: '共同灶台老萝卜炖肉', station: 'stove', process_kind: 'cooking_dish', input_items: [{ item_id: 'radish', quantity: 3, quality: 'normal' }, { item_id: 'firewood', quantity: 2, quality: 'normal' }], output_item_id: 'food_aged_radish_stew', output_quantity: 1, output_quality: 'normal' },
    ...
    { id: 'shared_hunters_roast', label: '共同灶台猎人烤', station: 'stove', process_kind: 'cooking_dish', input_items: [{ item_id: 'wild_mushroom', quantity: 3, quality: 'normal' }, { item_id: 'herb', quantity: 2, quality: 'normal' }, { item_id: 'pine_cone', quantity: 1, quality: 'normal' }], output_item_id: 'food_hunters_roast', output_quantity: 1, output_quality: 'normal' },
    ...
    { id: 'shared_spicy_hotpot', label: '共同灶台麻辣火锅', station: 'stove', process_kind: 'cooking_dish', input_items: [{ item_id: 'chili', quantity: 2, quality: 'normal' }, { item_id: 'cabbage', quantity: 1, quality: 'normal' }, { item_id: 'firewood', quantity: 1, quality: 'normal' }], output_item_id: 'food_spicy_hotpot', output_quantity: 1, output_quality: 'normal' },
    { id: 'shared_bamboo_shoot_stir_fry', label: '共同灶台冬笋炒肉', station: 'stove', process_kind: 'cooking_dish', input_items: [{ item_id: 'winter_bamboo_shoot', quantity: 2, quality: 'normal' }, { item_id: 'firewood', quantity: 1, quality: 'normal' }], output_item_id: 'food_bamboo_shoot_stir_fry', output_quantity: 1, output_quality: 'normal' },
    ...
    { id: 'shared_battle_stew', label: '共同灶台战斗炖菜', station: 'stove', process_kind: 'cooking_dish', input_items: [{ item_id: 'chili', quantity: 1, quality: 'normal' }, { item_id: 'potato', quantity: 1, quality: 'normal' }, { item_id: 'ginger', quantity: 1, quality: 'normal' }], output_item_id: 'food_battle_stew', output_quantity: 1, output_quality: 'normal' },
