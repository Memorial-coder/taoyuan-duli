...
assert.equal(withdrawalResult.room.gameplay.cavern_state.withdrawal_locked_combo_count, 3, 'cavern withdrawal should expose locked combo count')
assert.deepEqual(new Set(withdrawalResult.room.gameplay.cavern_state.withdrawal_locked_combo_ids), new Set(['route_then_mine', 'support_then_mine', 'route_with_support']), 'cavern withdrawal should expose locked combo ids')
...
assert.equal(receiptReplay.withdrawal_locked_combo_count, 3, 'cavern route replay should preserve locked combo count')
assert.deepEqual(new Set(receiptReplay.withdrawal_locked_combo_ids), new Set(['route_then_mine', 'support_then_mine', 'route_with_support']), 'cavern route replay should preserve locked combo ids')
