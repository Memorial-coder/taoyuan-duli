...
const BUILTIN_KNOWLEDGE_BASE = [
  ...
  },
  {
    ...
    access: 'public',
    content:
      '家园和小屋相关页面会影响每日休息、家庭互动与部分恢复效果。休息会推进到第二天；太晚睡或体力见底时，恢复效果可能会下降，还可能伴随额外损失。与配偶和家庭相关的互动会逐步解锁，包括孩子相关事件。',
  },
  {
    id: 'npc-village',
    title: '村庄、NPC 与社交',
    ...
    access: 'public',
    content:
      '村庄区域主要承载 NPC 互动、好感度成长和关系推进。提升好感通常有助于解锁更多对话、事件或奖励。部分剧情与心事件会随着关系推进触发，因此日常交流、送礼和按任务指引推进都很重要。',
  },
  {
    id: 'shop',
    title: '商店与采购',
