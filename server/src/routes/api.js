...
const ONLINE_RATE_LIMIT_RULES = Object.freeze([
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts(?:\/|$)/i,
    routeKey: 'cohabitation_contract_write',
    scope: 'cohabitation',
    maxRequests: 12,
  },
  {
...
const ONLINE_AUDIT_ROUTE_RULES = Object.freeze([
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts$/i,
    action: 'cohabitation_contract_create',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/accept$/i,
    action: 'cohabitation_contract_accept',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/separation-preview$/i,
    action: 'cohabitation_separation_preview',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/separation-previews\/([^/]+)\/confirm$/i,
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/separation-previews\/([^/]+)\/write-personal-farm-returns$/i,
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/separation-previews\/([^/]+)\/confirm-shared-fund-dispute$/i,
    action: 'cohabitation_separation_shared_fund_dispute_confirm',
  },
  {
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/separation-previews\/([^/]+)\/return-shared-warehouse$/i,
    action: 'cohabitation_separation_shared_warehouse_return',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/separation-previews\/([^/]+)\/split-decorations-buildings$/i,
    action: 'cohabitation_separation_decorations_buildings_split',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/separation-previews\/([^/]+)\/resolve-family-story$/i,
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/separation-previews\/([^/]+)\/resolve-child-arrangement$/i,
    action: 'cohabitation_separation_child_arrangement_resolve',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/separation-previews\/([^/]+)\/write-personal-family-receipts$/i,
    action: 'cohabitation_separation_personal_family_receipts_write',
  },
  {
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/shared-animals\/buy$/i,
    action: 'cohabitation_shared_animal_buy',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/shared-animals\/purchase$/i,
    action: 'cohabitation_shared_animal_purchase',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/shared-animals\/pet$/i,
    action: 'cohabitation_shared_animal_pet',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/shared-animals\/collect-product$/i,
    action: 'cohabitation_shared_animal_collect_product',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/shared-animals\/sell$/i,
    action: 'cohabitation_shared_animal_sell',
  },
  {
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/warehouse\/high-value-withdrawal-drafts\/([^/]+)\/compensation-review\/operator-receipt-audit$/i,
    action: 'cohabitation_warehouse_high_value_withdrawal_operator_receipt_audit_review',
  },
  {
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/fund\/large-spend-drafts\/([^/]+)\/confirm$/i,
    action: 'cohabitation_fund_large_spend_confirm',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/fund\/large-spend-drafts\/([^/]+)\/execute$/i,
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/materials\/consume$/i,
    action: 'cohabitation_family_building_materials_consume',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/rollback$/i,
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/request-review$/i,
    action: 'cohabitation_family_building_real_demolition_request_review',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/approve-review$/i,
    action: 'cohabitation_family_building_real_demolition_approve_review',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/request-execution$/i,
    action: 'cohabitation_family_building_real_demolition_request_execution',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/write-personal-save$/i,
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/verify-main-state-mapping$/i,
    action: 'cohabitation_family_building_real_demolition_main_state_mapping_verify',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/guard-main-state-mutation$/i,
    action: 'cohabitation_family_building_real_demolition_main_state_mutation_guard',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/execute-main-state-mutation$/i,
    action: 'cohabitation_family_building_real_demolition_main_state_mutation_execute',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/bind-main-state-exact-targets$/i,
    action: 'cohabitation_family_building_real_demolition_main_state_exact_targets_bind',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/execute-main-state-exact-targets$/i,
    action: 'cohabitation_family_building_real_demolition_main_state_exact_targets_execute',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/resolve-main-state-exact-targets$/i,
    action: 'cohabitation_family_building_real_demolition_main_state_exact_targets_resolve',
  },
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/execute-main-state-exact-mutation$/i,
    action: 'cohabitation_family_building_real_demolition_main_state_exact_mutation_execute',
  },
  {
  ...
  {
    matcher: /^\/api\/taoyuan\/online\/cohabitation\/contracts\/([^/]+)\/family-buildings\/real-demolition\/reject$/i,
    action: 'cohabitation_family_building_real_demolition_reject',
  },
  {
...
function normalizeRiskHeaderValue(value, maxLength = 160) {
  if (Array.isArray(value)) return normalizeRiskHeaderValue(value[0], maxLength);
  return String(value || '').normalize('NFKC').trim().slice(0, maxLength);
}

function getRequestIpAddress(req) {
  const forwardedFor = normalizeRiskHeaderValue(req.headers?.['x-forwarded-for'], 240);
  const forwardedIp = forwardedFor.split(',').map(part => part.trim()).filter(Boolean)[0] || '';
  return normalizeRiskHeaderValue(
    forwardedIp
...
function getSessionActor(req) {
  return {
    ...
    userAgent: normalizeRiskHeaderValue(req.headers?.['user-agent'], 240),
  };
}
...
function buildMailNotificationPayload(action, mail = {}) {
  return {
    ...
    mail: {
      ...
      recipient_username: normalizeUsernameKey(mail?.recipient_username || mail?.username),
      recipient_display_name: normalizeUsername(mail?.recipient_display_name || mail?.recipient_username || mail?.username),
      ...
      target_save_id: normalizeActivitySaveId(mail?.target_save_id ?? mail?.targetSaveId),
      target_save_slot: normalizeActivitySaveSlot(mail?.target_save_slot ?? mail?.targetSaveSlot),
...
function buildOnlineAuditDetail(req) {
  ...
  return {
    ...
    contract_id: sanitizeAuditValue(req.params?.contractId || body.contract_id || '', 80),
...
router.post('/taoyuan/online/manor/care', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  try {
    const result = await taoyuanManorRuntime.submitManorCareAction(req.body || {}, getSessionActor(req));
    res.json({ ok: true, ...result });
  } catch (error) {
...
router.post('/taoyuan/online/manor/steal', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  try {
    const result = await taoyuanManorRuntime.submitManorStealAction(req.body || {}, getSessionActor(req));
    res.json({ ok: true, ...result });
  } catch (error) {
...
router.get('/taoyuan/online/cohabitation/contracts', createOnlineReleaseGuard('manor'), loginRequired, async (req, res) => {
  try {
    const overview = await taoyuanCohabitationRuntime.listCohabitationContracts(req.session.username);
    res.json({ ok: true, ...overview });
  } catch (error) {
    res.status(error.status || 500).json({ ok: false, msg: error.message || '获取同居契约失败' });
  }
});
...
router.get('/taoyuan/online/cohabitation/contracts/:contractId/warehouse', createOnlineReleaseGuard('manor'), loginRequired, async (req, res) => {
  try {
    const result = await taoyuanCohabitationRuntime.getCohabitationWarehouse(req.params.contractId, getSessionActor(req));
    res.json({ ok: true, ...result });
  } catch (error) {
...
router.get('/taoyuan/online/cohabitation/contracts/:contractId/fund', createOnlineReleaseGuard('manor'), loginRequired, async (req, res) => {
  try {
    const result = await taoyuanCohabitationRuntime.getCohabitationFund(req.params.contractId, getSessionActor(req));
    res.json({ ok: true, ...result });
  } catch (error) {
...
router.get('/taoyuan/online/cohabitation/contracts/:contractId/roles', createOnlineReleaseGuard('manor'), loginRequired, async (req, res) => {
  try {
    const result = await taoyuanCohabitationRuntime.getCohabitationFamilyRoles(req.params.contractId, {
      username: req.session.username,
      displayName: req.session.display_name || req.session.username,
    });
    res.json({ ok: true, ...result });
  } catch (error) {
    res.status(error.status || 500).json({ ok: false, msg: error.message || '获取家族庄园职位失败' });
  }
});

router.get('/taoyuan/online/cohabitation/contracts/:contractId/family-orders', createOnlineReleaseGuard('manor'), loginRequired, async (req, res) => {
  try {
    const result = await taoyuanCohabitationRuntime.getCohabitationFamilyOrders(req.params.contractId, {
      username: req.session.username,
      displayName: req.session.display_name || req.session.username,
    });
    res.json({ ok: true, ...result });
  } catch (error) {
    res.status(error.status || 500).json({ ok: false, msg: error.message || '获取家族订单预备面板失败' });
  }
});

router.get('/taoyuan/online/cohabitation/contracts/:contractId/family-reputation', createOnlineReleaseGuard('manor'), loginRequired, async (req, res) => {
  try {
    const result = await taoyuanCohabitationRuntime.getCohabitationFamilyReputation(req.params.contractId, {
      username: req.session.username,
      displayName: req.session.display_name || req.session.username,
    });
    res.json({ ok: true, ...result });
  } catch (error) {
    res.status(error.status || 500).json({ ok: false, msg: error.message || '获取家族声望预备面板失败' });
  }
});

router.get('/taoyuan/online/cohabitation/contracts/:contractId/family-buildings', createOnlineReleaseGuard('manor'), loginRequired, async (req, res) => {
  try {
    const result = await taoyuanCohabitationRuntime.getCohabitationFamilyBuildings(req.params.contractId, {
      username: req.session.username,
      displayName: req.session.display_name || req.session.username,
    });
    res.json({ ok: true, ...result });
  } catch (error) {
    res.status(error.status || 500).json({ ok: false, msg: error.message || '获取家族建筑预备面板失败' });
  }
});

router.get('/taoyuan/online/cohabitation/contracts/:contractId/family-relations', createOnlineReleaseGuard('manor'), loginRequired, async (req, res) => {
  try {
    const result = await taoyuanCohabitationRuntime.getCohabitationFamilyRelations(req.params.contractId, {
      username: req.session.username,
      displayName: req.session.display_name || req.session.username,
    });
    res.json({ ok: true, ...result });
  } catch (error) {
    res.status(error.status || 500).json({ ok: false, msg: error.message || '获取家族关系图预备面板失败' });
  }
});
...
router.get('/taoyuan/online/cohabitation/contracts/:contractId/offline-status', createOnlineReleaseGuard('manor'), loginRequired, async (req, res) => {
  try {
    ...
    res.status(error.status || 500).json({ ok: false, msg: error.message || '获取离线经营状态失败' });
  }
});
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/warehouse/deposit', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.depositCohabitationWarehouseItem(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/warehouse/withdraw', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.withdrawCohabitationWarehouseItem(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/warehouse/high-value-withdrawal-drafts', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.createCohabitationWarehouseHighValueWithdrawalDraft(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/warehouse/high-value-withdrawal-drafts/:draftId/confirm', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.confirmCohabitationWarehouseHighValueWithdrawalDraft(req.params.contractId, req.params.draftId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/warehouse/high-value-withdrawal-drafts/:draftId/execute', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.executeCohabitationWarehouseHighValueWithdrawalDraft(req.params.contractId, req.params.draftId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/warehouse/sell', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.sellCohabitationWarehouseItem(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/warehouse/governance/recover', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.recoverCohabitationWarehouseGovernance(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/fund/contribute', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.contributeCohabitationFund(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/fund/spend', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.spendCohabitationFund(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/fund/shop-purchase', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.purchaseCohabitationSharedFundShopItem(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/fund/freeze-abnormality', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.freezeCohabitationFundAbnormality(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/fund/unfreeze-abnormality', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.unfreezeCohabitationFundAbnormality(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/fund/large-spend-draft', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.createCohabitationFundLargeSpendDraft(req.params.contractId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/fund/large-spend-drafts/:draftId/confirm', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.confirmCohabitationFundLargeSpendDraft(req.params.contractId, req.params.draftId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
      res.status(error.status || 500).json({ ok: false, msg: error.message || '确认共同基金大额草案失败' });
    }
  });
});

router.post('/taoyuan/online/cohabitation/contracts/:contractId/fund/large-spend-drafts/:draftId/execute', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.executeCohabitationFundLargeSpendDraft(req.params.contractId, req.params.draftId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/fund/large-spend-drafts/:draftId/high-risk-receipt', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
      const result = await taoyuanCohabitationRuntime.recordCohabitationFundHighRiskReceipt(req.params.contractId, req.params.draftId, req.body || {}, getSessionActor(req));
      res.json({ ok: true, ...result });
    } catch (error) {
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/accept', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  try {
    const result = await taoyuanCohabitationRuntime.acceptCohabitationContract(req.params.contractId, {
      username: req.session.username,
      displayName: req.session.display_name || req.session.username,
    });
    res.json({ ok: true, ...result });
  } catch (error) {
    res.status(error.status || 500).json({ ok: false, msg: error.message || '接受同居契约失败' });
  }
});
...
router.post('/taoyuan/online/cohabitation/contracts/:contractId/separation-previews/:previewId/confirm-shared-fund-dispute', createOnlineReleaseGuard('manor'), loginRequired, signRequired, async (req, res) => {
  return withTaoyuanExchangeLock(async () => {
    try {
...
router.get('/taoyuan/online/social/player-search', createOnlineReleaseGuard('social'), loginRequired, async (req, res) => {
  try {
    const result = await taoyuanSocialRuntime.searchPlayerBySaveId(req.session.username, req.query?.save_id);
    res.json({ ok: true, ...result });
  } catch (error) {
    res.status(error.status || 500).json({ ok: false, msg: error.message || '搜索玩家失败' });
  }
});
