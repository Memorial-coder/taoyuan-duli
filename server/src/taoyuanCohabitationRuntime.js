...
const SHARED_WORKSHOP_RECIPE_CATALOG = Object.freeze({
  ...
  shared_sesame_paste: {
    id: 'shared_sesame_paste',
    label: '共同石磨芝麻酱',
    station: 'stone_mill',
    process_kind: 'cooking_material',
    input_items: [{ item_id: 'sesame', quantity: 2, quality: 'normal' }],
    output_item_id: 'sesame_paste',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_sesame_powder: {
    id: 'shared_sesame_powder',
    label: '共同石磨芝麻粉',
    station: 'stone_mill',
    process_kind: 'cooking_material',
    input_items: [{ item_id: 'sesame', quantity: 2, quality: 'normal' }],
    output_item_id: 'sesame_powder',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_pumpkin_preserve: {
    id: 'shared_pumpkin_preserve',
    label: '共同酱缸南瓜酱',
    station: 'sauce_jar',
    process_kind: 'cooking_material',
    input_items: [{ item_id: 'pumpkin', quantity: 1, quality: 'normal' }],
    output_item_id: 'pumpkin_preserve',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_pickled_chili: {
    id: 'shared_pickled_chili',
    label: '共同酱缸泡椒',
    station: 'sauce_jar',
    process_kind: 'cooking_material',
    input_items: [{ item_id: 'chili', quantity: 2, quality: 'normal' }],
    output_item_id: 'pickled_chili',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_sesame_oil: {
    id: 'shared_sesame_oil',
    label: '共同油坊芝麻油',
    station: 'oil_press',
    process_kind: 'cooking_material',
    input_items: [{ item_id: 'sesame', quantity: 3, quality: 'normal' }],
    output_item_id: 'sesame_oil',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_lotus_heart_powder: {
    id: 'shared_lotus_heart_powder',
    label: '共同药碾莲心粉',
    station: 'herb_grinder',
    process_kind: 'cooking_material',
    input_items: [{ item_id: 'dried_lotus_seed', quantity: 1, quality: 'normal' }],
    output_item_id: 'lotus_heart_powder',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_rice_ball: {
  ...
  shared_rice_flour_roll: {
    id: 'shared_rice_flour_roll',
    label: '共同灶台米粉卷',
    station: 'stove',
    process_kind: 'cooking_dish',
    input_items: [
      { item_id: 'rice_flour', quantity: 1, quality: 'fine' },
      { item_id: 'dried_radish', quantity: 1, quality: 'normal' },
    ],
    output_item_id: 'food_rice_flour_roll',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_sesame_tangyuan: {
    id: 'shared_sesame_tangyuan',
    label: '共同灶台芝麻汤圆',
    station: 'stove',
    process_kind: 'cooking_dish',
    input_items: [
    ...
    output_item_id: 'food_sesame_tangyuan',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_lotus_sesame_calming_cake: {
    ...
    output_item_id: 'food_lotus_sesame_calming_cake',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_spicy_pumpkin_rice: {
    id: 'shared_spicy_pumpkin_rice',
    label: '共同灶台赛舟辣南瓜饭',
    station: 'stove',
    process_kind: 'cooking_dish',
    input_items: [
    ...
    output_item_id: 'food_spicy_pumpkin_rice',
    output_quantity: 1,
    output_quality: 'normal',
  },
  shared_herb_paste: {
