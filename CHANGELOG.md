...
- 茶叶料理 / 炼丹差异：茶叶用途表补入 `alchemy` 标签与茶心凝神丹推荐用途，和既有绿茶、待客清茶、茶宴饮品、NPC 好感赠礼、茶商订单形成可搜索的制茶 / 炼丹双路径。
- 辣椒加工 / 炼丹差异：辣椒用途表补入 `pickle` 标签与泡椒推荐用途，泡椒继续承接辛火行气丸、赛舟饭团和辛火赛舟饭团链路，背包用途筛选与百科搜索可按腌制路径反查。
